document.addEventListener("DOMContentLoaded", function () {
    const sliderWrap = document.querySelector(".home-products_slider-wrap");
    const cards = document.querySelectorAll(".home-products_slider-card");
    const lastCard = document.querySelector(".home-products_slider-card.is-last");
